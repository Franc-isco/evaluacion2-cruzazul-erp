        ...
        <div class="card">
          <div class="brand">
            ...
            <div class="brand-text">
              <h1>Cruz Azul ERP</h1>
              <p>Portal seguro con Auto Scaling</p>
            </div>
          </div>

          <span class="badge">🛡️ MFA + JWT + Load Balancer</span>
          ...
          <p class="info">
            Portal Web ERP desplegado en AWS con Node.js, Express y autenticación segura.
          </p>
        </div>
      </div>
    </body>
      ...
      <body>
        <div class="login-container">
          <div class="card">
            ...
            <span class="badge">✅ Segundo factor</span>

            <p class="info">
              Escanee el QR con Google Authenticator e ingrese el código temporal de 6 dígitos.
            </p>

            <div style="text-align:center; margin: 15px 0;">
              <img src="${qrDataUrl}" alt="QR MFA" style="max-width:180px;">
            </div>
        ...
        <div class="container">
          <div class="topbar">
            <div>
              ...
              <p>Arquitectura con Load Balancer, Auto Scaling y CloudWatch</p>
            </div>
          ...
          <div class="grid">
            <div class="stat-card">
              ...
              <h3>Load Balancer</h3>
              <p>Distribuye el tráfico hacia las instancias Web ERP del Auto Scaling Group.</p>
            </div>

            <div class="stat-card">
              <div class="stat-icon">📈</div>
              <h3>Auto Scaling</h3>
              <p>Permite aumentar o reducir instancias según métricas de rendimiento.</p>
            </div>

            <div class="stat-card">
              <div class="stat-icon">🗄️</div>
              <h3>PostgreSQL IaaS</h3>
              <p>Base de datos dockerizada en una instancia EC2 privada.</p>
            </div>
          </div>

          <section class="section-card">
            <h2>🛡️ Estado del sistema</h2>
            <p><strong>Instancia actual:</strong> ${hostname}</p>
            <p><strong>Base de datos:</strong> PostgreSQL dockerizado en EC2</p>
            <p><strong>Conexión BD:</strong> Correcta</p>
            <p><strong>Hora desde PostgreSQL:</strong> ${resultado.rows[0].fecha_servidor}</p>
          </section>
        ...
        <div class="container">
          <div class="topbar">
            <div>
              ...
              <p>Productos almacenados en PostgreSQL IaaS</p>
            </div>
...
app.listen(PORT, () => {
  console.log(`Servidor Cruz Azul ERP Auto Scaling ejecutándose en puerto ${PORT}`);
});
